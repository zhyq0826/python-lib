...
class Session(utils.ThreadedDict):
    ...
    def _processor(self, handler):
        ...
        print 'current request session threading is --> ',id(t)
        print 'current storage is -->'
        try:
            return handler()
            print 'after handler'
        finally:
    ...
    def _save(self):
        ...
        if not self.get('_killed'):
            ...
            print 'set cookies',self.session_id
